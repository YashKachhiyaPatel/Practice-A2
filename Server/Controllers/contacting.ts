...
export function DisplayContactingEditPage(req: Request, res: Response, next: NextFunction): void
{
    ...
    Contacting.findById(id, {}, {}, (err, contactingItemToEdit) => 
    {
        ...
        // show the edit view
        res.render('index', { title: 'cEdit', page: 'contactingupdate', contacting: contactingItemToEdit, displayName: UserDisplayName(req)  });
    });
}
...
{
    // show the edit view
    res.render('index', { title: 'cAdd', page: 'contactingupdate', contacting: '', displayName: UserDisplayName(req) });
}
