...
function DisplayContactingEditPage(req, res, next) {
    ...
    contacting_1.default.findById(id, {}, {}, (err, contactingItemToEdit) => {
        ...
        res.render('index', { title: 'cEdit', page: 'contactingupdate', contacting: contactingItemToEdit, displayName: Util_1.UserDisplayName(req) });
    });
}
exports.DisplayContactingEditPage = DisplayContactingEditPage;
function DisplayContactAddPage(req, res, next) {
    res.render('index', { title: 'cAdd', page: 'contactingupdate', contacting: '', displayName: Util_1.UserDisplayName(req) });
}
